...
@Scope("session")
@ACFgFunction(id="")
@RequestMapping(value=APGtMapping.APG) 
public class APGc extends ACFaAppController {
    ...
    public APGc() throws Exception {
        super();
    }
    
     
    
    @RequestMapping(value=APGtMapping.APG_PAYMENTDETAILS_AJAX, method=RequestMethod.POST)
    @ResponseBody
    ...
    @RequestMapping(value=APGtMapping.APG_PROGRAMME_FIELDS_AJAX, method=RequestMethod.POST)
    @ResponseBody
...
//    
    @RequestMapping(value=APGtMapping.APG_BUSINESSPLATFORM_DESC_AJAX, method=RequestMethod.POST)
    @ResponseBody
