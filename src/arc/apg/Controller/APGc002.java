...
// import arc.apf.Static.APGtMapping;

// @Controller
// @Scope("session")
// @ACFgFunction(id="APGF002")
// @RequestMapping(value=APGtMapping.APGF002)
// public class APGc002 extends ACFaAppController {
// 
// 	@RequestMapping(value=APGtMapping.APGF002_MAIN, method=RequestMethod.GET)
...
public class APGc002 extends ACFaAppController {
        ...
        public Search() {
          ...
          //SQL to combine two tables to form one grid in browser function
            setCustomSQL("select * from (select pr.payment_form_no, pr.request_date, pr.section_id, pr.request_department, pr.supplier_code, pr.despatch_date, pr.remarks, sp.supplier_name " +
                    ...
                    + "and (pr.section_id = '02') and (sp.supplier_code = 'CASH')) ");
 ...
 //      model.addAttribute("getsuppliercode", supplierService.getSupplierPairs());  only 'CASH' can be selected     
    ...
    @RequestMapping(value=APGtMapping.APGF002_SEARCH_AJAX, method=RequestMethod.POST)
    @ResponseBody
    ...
    @RequestMapping(value=APGtMapping.APGF002_GET_SUPPLIER_NAME_AJAX, method=RequestMethod.POST)
    @ResponseBody
    ...
    @RequestMapping(value=APGtMapping.APGF002_GET_PAYMENTDETAILS_TABLE_AJAX, method=RequestMethod.POST) //get rows of the second grid
    @ResponseBody
    public ACFgResponseParameters getPaymentDetailsTable(@RequestBody ACFgRequestParameters param) throws Exception {
     ...
     @RequestMapping(value=APGtMapping.APGF002_GET_FORM_AJAX, method=RequestMethod.POST)
        @ResponseBody
     ...
     @ACFgTransaction
        @RequestMapping(value=APGtMapping.APGF002_SAVE_AJAX, method=RequestMethod.POST)
        @ResponseBody
