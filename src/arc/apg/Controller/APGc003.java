...
import arc.apg.Static.APGtGlobal;
import arc.apg.Static.APGtMapping;

@Controller
@Scope("session")
@ACFgFunction(id="APGF003")
@RequestMapping(value=APGtMapping.APGF003)
public class APGc003 extends ACFaAppController {
	...
	private class Search extends ACFgSearch {
		public Search() {
			...
			setCustomSQL("select * from (select t1.process_date as process_date, t1.process_date as p_date, t1.section_id as section_id, t1.programme_no as programme_no,  " +
	                 ...
	                 "  and t1.section_id = '"+APGtGlobal.APG_SECTION_ID+"')");			
	...
	@RequestMapping(value=APGtMapping.APGF003_MAIN, method=RequestMethod.GET)
	public String main(ModelMap model) throws Exception {

		model.addAttribute("labourselect", labourTypeService.getAllEffLabourTypebySection(APGtGlobal.APG_SECTION_ID));
	...
	@RequestMapping(value=APGtMapping.APGF003_SEARCH_AJAX, method=RequestMethod.POST)
	@ResponseBody
	...
	@RequestMapping(value=APGtMapping.APGF003_GET_FORM_AJAX, method=RequestMethod.POST)
	@ResponseBody
	...
	@RequestMapping(value=APGtMapping.APGF003_GET_CONSUME_DTL_AJAX, method=RequestMethod.POST)
	@ResponseBody
	...
	@ACFgTransaction
	@RequestMapping(value=APGtMapping.APGF003_SAVE_AJAX, method=RequestMethod.POST)
	@ResponseBody
    ...
    @RequestMapping(value=APGtMapping.APGF003_GET_ARC_PROGRAMME_AJAX, method=RequestMethod.POST)
    @ResponseBody
    ...
    @RequestMapping(value=APGtMapping.APGF003_GET_LABOUR_TYPE_AJAX, method=RequestMethod.POST)
    @ResponseBody
    public ACFgResponseParameters getLabourType(@RequestBody ACFgRequestParameters param) throws Exception {
        ...
        System.out.println("APG get labour " + param.get("labour_type", String.class) + ' ' + input_date);
