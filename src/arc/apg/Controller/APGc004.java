...
@Controller
@Scope("session")
@ACFgFunction(id="APGF004")
@RequestMapping(value=APGtMapping.APGF004)
public class APGc004 extends ACFaAppController {
	...
	String section_id = APGtGlobal.APG_SECTION_ID;
	...
	@RequestMapping(value=APGtMapping.APGF004_MAIN, method=RequestMethod.GET)
	...
	@RequestMapping(value=APGtMapping.APGF004_SEARCH_AJAX, method=RequestMethod.POST)
	@ResponseBody
	...
	@RequestMapping(value=APGtMapping.APGF004_GET_FORM_AJAX, method=RequestMethod.POST)
	@ResponseBody
	...
	@RequestMapping(value=APGtMapping.APGF004_GET_PAYMENT_AJAX, method=RequestMethod.POST)
	@ResponseBody
	...
	@ACFgTransaction
	@RequestMapping(value=APGtMapping.APGF004_SAVE_AJAX, method=RequestMethod.POST)
	@ResponseBody
    ...
    @RequestMapping(value=APGtMapping.APGF004_GET_SUPPLIER_AJAX, method=RequestMethod.POST)
    @ResponseBody
