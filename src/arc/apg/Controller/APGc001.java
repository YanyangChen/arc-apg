...
// @Controller
// @Scope("session")
// @ACFgFunction(id="APGF001")
// @RequestMapping(value=APGtMapping.APGF001)
// public class APGc002 extends ACFaAppController {
// 
// 	@RequestMapping(value=APGtMapping.APGF001_MAIN, method=RequestMethod.GET)
...
@ACFgFunction(id="APGF001")
@RequestMapping(value=APGtMapping.APGF001)
public class APGc001 extends ACFaAppController {
        ...
        public Search() {
          ...
          //SQL to combine two tables to form one grid in browser function
            setCustomSQL("select * from (select a.payment_form_no, a.request_date, a.section_id, a.request_department, "
                    ...
                    "where (a.supplier_code = b.supplier_code) and (a.section_id = '02') and (a.supplier_code <> 'CASH')) ");
   ...
   //    model.addAttribute("subsectionidselect", SectionService.getAllSubSectionName8());
    ...
    @RequestMapping(value=APGtMapping.APGF001_SEARCH_AJAX, method=RequestMethod.POST)
    @ResponseBody
    ...
    @RequestMapping(value=APGtMapping.APGF001_GET_SUPPLIER_NAME_AJAX, method=RequestMethod.POST)
    @ResponseBody
    ...
    @RequestMapping(value=APGtMapping.APGF001_GET_PAYMENTDETAILS_TABLE_AJAX, method=RequestMethod.POST) //get rows of the second grid
    @ResponseBody
   ...
   //                 + "where pr.payment_form_no = pd.payment_form_no )");
     ...
     @RequestMapping(value=APGtMapping.APGF001_GET_FORM_AJAX, method=RequestMethod.POST)
        @ResponseBody
     ...
     @ACFgTransaction
        @RequestMapping(value=APGtMapping.APGF001_SAVE_AJAX, method=RequestMethod.POST)
        @ResponseBody
            ...
            ARCmPaymentRequest lastItem = paymentrequestDao.saveItems(amendments, new ACFiSQLAssWriteInterface<ARCmPaymentRequest>(){
                ...
                public boolean delete(ARCmPaymentRequest oldItem, ACFdSQLAssDelete ass) throws Exception {
                	if(!oldItem.despatch_date.equals(Timestamp.valueOf("1900-01-01 00:00:00"))){
                		throw exceptionService.error("APG004E");
                	}
