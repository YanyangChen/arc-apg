...
<div class="col-md-12 nopadding">
	...
	<acf:Region id="reg_div_list" type="list" title="PAYMENT REQUEST LIST">
		...
		<div class="col-xs-12">
			<acf:Grid id="grid_browse" url="apgf001-search.ajax" readonly="true" autoLoad="false">
...
<!--   <acf:Region id="reg_form" title="PAYMENT REQUEST LIST">-->
			   		...
			   		<acf:Bind on="change"><script>
   						...
   						if (supplier_code == ""){
	   						...
	   						$.ajax({
								...
								async  : false,
								type   : "POST",
								url    : "${ctx}/arc/apg/apgf001/apgf001-apg-get-supplier-name.ajax",
								data   : JSON.stringify({
	...
	<acf:Region id="payment_details" title="PAYMENT DETAILS" type="list">			
		<div class="col-md-12">
			<acf:Grid id="grid_paymentdetails" url="apgf001-get-paymentdetails-table.ajax" autoLoad="false" addable="true" deletable="true" editable="true" rowNum="9999" multiLineHeader="true">
...
Controller.setOption({
    ...
    getUrl: "apgf001-get-form.ajax",
	saveUrl: "apgf001-save.ajax",
