...
<form id="frm_main" class="form-horizontal" data-role="form" >
	...
	<acf:Region id="payment_request_headers" title="DESPATCH DATE MAINTENANCE OF LIGHTING" type="form">

		<div class="col-md-12">			
			<acf:Grid id="grid_payment_request" url="apgf004-get-payment.ajax" autoLoad="false" addable="false" deletable="false" editable="true" rowNum="20">
...
Controller.setOption({
	...
	getUrl: "apgf004-get-payment.ajax",
	saveUrl: "apgf004-save.ajax",
