...
<acf:Region id="reg_list" title="LABOUR CONSUMPTION LIST" type="form">
	<div class="widget-main no-padding">
		<div class="col-md-12 form-padding">
			<acf:Grid id="grid_browse" url="apgf003-search.ajax" readonly="true">
...
<form id="frm_main" class="form-horizontal" data-role="form" >
	...
	<acf:Region id="reg_form" title="LABOUR CONSUMPTION MAINTENANCE OF LIGHTING">
		<div class="form-group">		
	      				...
	      				<acf:Bind target="button" on="click"><script>
   						...
   						if ($.trim(programme_no) != ""){ 
	   						$.ajax({
								...
								async  : false,
								type   : "POST",
								url    : "apgf003-get-arc-programme.ajax",
								data   : JSON.stringify({
		...
		<div class="hidden">
			<input id="section_id" name="section_id" value="02"/>
	...
	<acf:Region id="consumption_details" title="LABOUR CONSUMPTION DETAILS" type="form">	
		...
		<div class="col-md-12">			
			<acf:Grid id="grid_consume_dtl" url="apgf003-get-consume-dtl.ajax" autoLoad="false" addable="true" deletable="true" editable="true" rowNum="9999" multiLineHeader="true">
					...
					<acf:Bind on="validate"><script>
						function validation (newValue, oldValue, newData, oldData, id) {
							...
							$.ajax({
								...
								async  : false,
								type   : "POST",
								url    : "apgf003-get-labour-type.ajax",
								data   : JSON.stringify({
...
Controller.setOption({
	...
	getUrl: "apgf003-get-form.ajax",
	saveUrl: "apgf003-save.ajax",
